...
>
    <head>
        ...
        <link
            rel="stylesheet"
            href="{{ asset('') }}vuexy-admin/assets/vendor/fonts/fontawesome.css"
        />
        <link
            rel="stylesheet"
            href="{{ asset('') }}vuexy-admin/assets/vendor/fonts/tabler-icons.css"
        />
        <link
            rel="stylesheet"
            href="{{ asset('') }}vuexy-admin/assets/vendor/fonts/flag-icons.css"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('') }}vuexy-admin/assets/vendor/libs/%40form-validation/form-validation.css"
        />
        ...
        <link
            rel="stylesheet"
            href="{{ asset('') }}vuexy-admin/assets/vendor/css/pages/page-auth.css"
        />
    ...
    <body>
        ...
        <!-- Vendors JS -->
        <script src="{{ asset('') }}vuexy-admin/assets/vendor/libs/%40form-validation/popular.js"></script>
        <script src="{{ asset('') }}vuexy-admin/assets/vendor/libs/%40form-validation/bootstrap5.js"></script>
        <script src="{{ asset('') }}vuexy-admin/assets/vendor/libs/%40form-validation/auto-focus.js"></script>

        <!-- Main JS -->
        <script src="{{ asset('') }}vuexy-admin/assets/js/main.js"></script>

        <!-- Page JS -->
        <script src="{{ asset('') }}vuexy-admin/assets/js/pages-auth.js"></script>
    </body>
</html>
