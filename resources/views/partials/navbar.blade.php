            ...
            >
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar">
                    <img
                      src="{{asset('')}}vuexy-admin/assets/img/avatars/1.png"
                      alt
            ...
            >
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar">
                    <img
                      src="{{asset('')}}vuexy-admin/assets/img/avatars/2.png"
                      alt
                      class="h-auto rounded-circle"
                    />
                  </div>
            ...
            >
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar">
                    <img
                      src="{{asset('')}}vuexy-admin/assets/img/avatars/9.png"
                      alt
                      class="h-auto rounded-circle"
                    />
                  </div>
            ...
            >
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar">
                    <img
                      src="{{asset('')}}vuexy-admin/assets/img/avatars/5.png"
                      alt
                      class="h-auto rounded-circle"
                    />
                  </div>
            ...
            >
              <div class="d-flex">
                <div class="flex-shrink-0 me-3">
                  <div class="avatar">
                    <img
                      src="{{asset('')}}vuexy-admin/assets/img/avatars/6.png"
                      alt
                      class="h-auto rounded-circle"
                    />
                  </div>
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      >
        <div class="avatar avatar-online">
          <img
            src="{{ asset('storage/foto-profile/')}}/{{auth()->user()->foto_profile}}"
            alt
            class="h-auto rounded-circle"
          />
        </div>
