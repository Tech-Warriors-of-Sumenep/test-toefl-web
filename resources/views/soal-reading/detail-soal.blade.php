                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="{{ route('soal-reading.edit', $soal->id) }}"><i
                                                    class="ti ti-pencil me-1"></i> Edit</a>
                                            <form action="{{ route('soal-reading.destroy', $soal->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="dropdown-item"><i
                                                        class="ti ti-trash me-1"></i> Delete</button>
                                            </form>
                                            <a class="dropdown-item" href="{{ route('soal-reading.show', $soal->id) }}"><i
