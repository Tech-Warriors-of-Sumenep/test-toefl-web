              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{ route('ujian.edit', ['code'=> $item->uuid]) }}"><i class="ti ti-pencil me-1"></i> Edit</a>
                    <form action="{{ route('ujian.destroy', ['code'=> $item->uuid]) }}" method="POST">
                      @csrf
                      @method('DELETE')
