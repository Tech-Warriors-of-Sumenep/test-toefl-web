        ...
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('jawaban.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="soal" value="<?php echo e($soal); ?>">
                            <div class="mb-3">
...
<?php echo $__env->make('layouts.layout-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PENS\semester 4\data_end\test-toefl-web\resources\views/jawaban/create.blade.php ENDPATH**/ ?>