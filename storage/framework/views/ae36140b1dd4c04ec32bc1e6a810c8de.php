<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold">TestToefl</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small text-uppercase">
            <span class="menu-header-text" data-i18n="Materi">Materi</span>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="/ujian-grammar" class="menu-link">
                ...
                <div data-i18n="Ujian Grammar">Ujian Grammar</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/ujian-reading" class="menu-link">
                <i class="menu-icon tf-icons ti ti-notes"></i>
                <div data-i18n="Ujian Reading">Ujian Reading</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/ujian-listening" class="menu-link">
                <i class="menu-icon tf-icons ti ti-notes"></i>
                <div data-i18n="Ujian Listening">Ujian Listening</div>
            </a>
        </li>
...
<?php /**PATH D:\file yoga\kuliah\semester 4\workshop aplikasi bergerak\uas\backend-web\test-toefl-web\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>