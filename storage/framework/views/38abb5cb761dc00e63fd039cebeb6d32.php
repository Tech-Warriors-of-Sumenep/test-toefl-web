    ...
    <div class="card">
        <div class="row g-0">
            ...
            <div class="col-lg-6 p-4" style="display: flex; height: auto; align-items: center; justify-content:end">
                <a href="<?php echo e(route('ujian.create')); ?>" class="">
              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo e(route('ujian.edit', ['code'=> $item->uuid])); ?>"><i class="ti ti-pencil me-1"></i> Edit</a>
                    <form action="<?php echo e(route('ujian.destroy', ['code'=> $item->uuid])); ?>" method="POST">
                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Semester 4\Workshop Pemrograman Perangkat Bergerak\test-toefl-web\resources\views/ujian/index.blade.php ENDPATH**/ ?>