              ...
              <td>
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="<?php echo e(route('materiReading.edit', $materi1->uuid)); ?>"><i class="ti ti-pencil me-1"></i> Edit</a>
                    <form action="<?php echo e(route('materiReading.destroy', $materi1->uuid)); ?>" method="POST">
                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\file yoga\kuliah\semester 4\workshop aplikasi bergerak\uas\backend-web\test-toefl-web\resources\views/materiReading/index.blade.php ENDPATH**/ ?>