            ...
            <tbody>
                <?php $__currentLoopData = $flipMateris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flipMateri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><a href="<?php echo e($flipMateri->file); ?>" target="_blank">Lihat File</a></td>
                        <td>
...
<?php echo $__env->make('layouts.layout-dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\sumenepteam\test-toefl-web\resources\views/materiGrammar/index.blade.php ENDPATH**/ ?>